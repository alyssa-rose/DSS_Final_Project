...
3. http://clima1.cptec.inpe.br/spi/pt

# References
1. [A generalized simulation development approach for predicting refugee destinations](https://www.nature.com/articles/s41598-017-13828-9)
...
3. [Climate change and internal migration patterns in Bangladesh: an agent-based model](https://www-jstor-org.ezproxy.library.tufts.edu/stable/26265549?seq=1#metadata_info_tab_contents)
